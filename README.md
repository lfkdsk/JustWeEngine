...
* [1.基础功能](#1.基础功能)
	* [1.1继承引擎核心类](#1.1继承引擎核心类)
	* [1.2绘制文字](#1.2绘制文字)
	* [1.3绘制图片](#1.3绘制图片)
	* [1.4使用精灵](#1.4使用精灵)
	* [1.5使用按钮](#1.5使用按钮)
* [2.动画系统](#2.动画系统)
	* [2.1绑定在`BaseSub`（物品及精灵基类）上的动画类](#2.1绑定在`BaseSub`（物品及精灵基类)
	* [2.2绑定在`Button`上的动画类](#2.2绑定在`Button`上的动画类)
* [3.碰撞检测和死亡判定](#3.碰撞检测和死亡判定)
* [4.屏幕扫描模式](#4.屏幕扫描模式)
* [5.工具类](#5.工具类)
